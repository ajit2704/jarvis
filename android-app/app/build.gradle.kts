...
android {
    namespace = "com.jarvis.voiceassistant"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.jarvis.voiceassistant"
        minSdk = 35
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    // ============================================
    // Moonshine STT (Step 0.1 - VERIFIED ✅)
    // ============================================
    implementation("ai.moonshine:moonshine-voice:0.0.48")
    
    // ============================================
    // LLM Runtime - RunAnywhere SDK (Step 0.3)
    // ============================================
    ...
    // ============================================
    // Kotlin Coroutines (Required for threading)
    // ============================================
